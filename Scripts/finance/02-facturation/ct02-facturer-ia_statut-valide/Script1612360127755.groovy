...
WebUI.click(findTestObject('finance/16-facturation/Page_IAD Intranet/button_fermer'))
...
WebUI.verifyElementText(findTestObject('finance/17-facturation-ia/Page_IAD/p_valide'), 'Validée')
