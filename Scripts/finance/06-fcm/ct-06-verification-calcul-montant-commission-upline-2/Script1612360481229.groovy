...
k = WebUI.getText(findTestObject('finance/03-fcm/td_300'))
...
l = WebUI.getText(findTestObject('finance/03-fcm/td_1023'))
...
println(l4)
GlobalVariable.comUpline2=l4
println GlobalVariable.comUpline2
